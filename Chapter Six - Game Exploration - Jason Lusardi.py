...
def introscreen():
    ...
    while run :
        ...
        ### changing from inactive to active by changing the color from white to red 
            pygame.draw.rect(screen, (155,100,0), button2,6)
        ...
        ### changing from inactive to active by changing the color from white to red 
            pygame.draw.rect(screen,(155,0,100),button3,6)
...
def countdown():
    ...
    three = font2.render('3',True, (187,210,16))
    two =   font2.render('2',True, (250,255,0))
    one =   font2.render('1',True, (51,165,60))
    go =    font2.render('GO!!!',True, (0,255,30))
...
#Changes Made to Lines 93, 102, 121, 122, 123, and 124